...
// GET /api/decks-by-user/simplified/:userId — retrieve simplified decks for a user
router.get('/simplified/:userId', asyncHandler(DeckByUserController.getSimplifiedDecks));
